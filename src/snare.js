...
var io_dp = {
    ...
    __if_op: function () {
        ...
        try {
            ...
            _i_cr.__if_fc("JSSRC", _i_o.__if_ap("ZWMyLTUyLTMyLTEyOS0xMTgudXMtd2VzdC0yLmNvbXB1dGUuYW1hem9uYXdzLmNvbQ=="));
            _i_cr.__if_fc("UAGT", navigator.userAgent.slice(0, 400));
            if (!__if_h()) {
                _i_cr.__if_fc("JSTOKEN", "FFIyhvVeL+DsSGdpl0SWe8Ki5liCJcbVDBeEKT5d+Io=");
            }
            var _i_fd = decodeURIComponent("Mozilla%2F5.0%20(Macintosh%3B%20Intel%20Mac%20OS%20X%2010.16%3B%20rv%3A84.0)%20Gecko%2F20100101%20Firefox%2F84.0");
            if (navigator.userAgent != _i_fd) {
                _i_cr.__if_fc("JDIFF", "1");
                _i_cr.__if_fc("SUAGT", _i_fd.slice(0, 400));
            }
            _i_cr.__if_fc("HACCLNG", decodeURIComponent("en-US%2Cen%3Bq%3D0.5"));
            ...
            _i_cr.__if_fc("SVRTIME", "2021/01/27 21:56:02");
            var _i_dq = new __if_d();
            ...
            _i_cr.__if_fc("IGGY", "Y3yklwGvbrJNSJjdMkQf6+Uh4U2RsqQQKKxC5Zl+lff0J9PbW/z3S3t9vKfjFKK5");
...
try {
    ...
    var _i_fo = new __if_g(_i_o.__if_ap("aHR0cHM6Ly9tcHNuYXJlLmllc25hcmUuY29tLw==") + "stmgwb2.swf", (__if_h()) ? "" : "FFIyhvVeL+DsSGdpl0SWe8Ki5liCJcbVDBeEKT5d+Io=");
    io_cm.push(_i_fm, _i_fn, io_adp, _i_fo);
    if (__if_h()) _i_cr.__if_fc("FLRTD", "FFIyhvVeL+DsSGdpl0SWe8Ki5liCJcbVDBeEKT5d+Io=");
    else _i_fm._if_hn = _i_fn._if_hn = "FFIyhvVeL+DsSGdpl0SWe8Ki5liCJcbVDBeEKT5d+Io=";
    try {
        var _i_dl = document.getElementsByTagName('head')[0];
